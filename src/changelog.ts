...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      'Ficha del jugador: botón «Exportar informe» (icono ⬇, junto a Editar) que genera un PDF de una página con la ficha deportiva, el contrato y todos los informes de partido y notas de rendimiento — listo para compartir. No incluye nada de Captación ni datos personales (teléfono, familia…)',

...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      'Captación → nueva pestaña «Estadísticas»: cuadro de control de cobertura. Arriba, equipos, relevantes, % cubiertos, jugadores en Llamar y en Seguir. Debajo, el desglose por zona o por categoría (cobertura, jugadores, en Llamar y el reparto de etiquetas) ordenado por dónde hay más gente en Llamar, descargable a CSV. Y dos listas: los equipos con más jugadores en Llamar, y los relevantes que se están quedando sin cubrir — con un clic se abre la ficha del equipo',

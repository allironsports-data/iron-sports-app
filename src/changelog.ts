...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      'Pipeline → nueva pestaña «Por zona»: la vista por zonas ya existía, pero estaba escondida en un selector pequeño dentro del tablero. Ahora es una pestaña propia, y el selector interno se queda con Estatus y Encargado',
      'Pipeline → nueva pestaña «Por encargado»: el panel de trabajo de cada uno. Cuatro bloques con lo que urge — qué toca hoy (acciones vencidas o de hoy), se están enfriando (las que pasan la cadencia de su estatus), mis calientes y las que esperan teléfono — y debajo el pipeline entero: un embudo por estatus que al pulsarlo filtra, y una tabla con estatus, zona, días parada y próxima acción, ordenable y descargable a CSV. Se abre en el tuyo y hay un desplegable para ver el de cualquier compañero',

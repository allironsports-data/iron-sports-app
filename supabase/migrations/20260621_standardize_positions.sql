...
returns text language sql immutable as $$
  select case lower(trim(coalesce(x, '')))
    ...
    when 'dm' then 'DM' when 'cdm' then 'DM' when 'mcd' then 'DM' when 'pivote' then 'DM' when 'mediocentro defensivo' then 'DM' when 'centrocampista defensivo' then 'DM' when 'contencion' then 'DM'
    when 'cm' then 'CM' when 'mc' then 'CM' when 'mediocentro' then 'CM' when 'medio centro' then 'CM' when 'interior' then 'CM' when 'centrocampista' then 'CM' when 'mediocampista' then 'CM' when 'medio' then 'CM' when 'volante' then 'CM'
    when 'am' then 'AM' when 'cam' then 'AM' when 'mp' then 'AM' when 'mco' then 'AM' when 'mediapunta' then 'AM' when 'media punta' then 'AM' when 'mediocentro ofensivo' then 'AM' when 'centrocampista ofensivo' then 'AM' when 'enganche' then 'AM'
